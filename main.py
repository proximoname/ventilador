...
class ventiladorApp:
    ...
    def abrir_janela_ventilador(self):
        ...
        self.animar()
    def animar(self):
        if not self.janela_fan.winfo_exist():
            return
        ...
        for i in range(3):
            ...
            self.canvas.creat.line(cx, cy, x, y, width=15, fill="black", tags="pas", capstyle="round")
            
            
        self.canvas.creat_oval(cx-10, cy-10, cx+10, cy+10, fill="black", tags="pas")
        
        self.anguo += self.velocidade
